            ...
            <div className="lg:px-14 sm:px-8 px-4 w-full flex justify-between" >
                ...
                <ul className={`flex sm:gap-10 gap-4 sm:items-center  text-slate-800 sm:static absolute left-0 top-[70px] sm:shadow-none shadow-md ${
                    ...
                    <li className="font-[500] transition-all duration-150">
                        <Link className={`${
                            path === "/" ? "text-gray-200 font-normal underline" : "text-white font-semibold"
                        }`}
                        to="/" > Home</Link>
                    </li>
                    ...
                    <li className="font-[500] transition-all duration-150">
                        <Link className={`${
                            path === "/products" ? "text-gray-200 font-normal underline" : "text-white font-semibold"
                        }`}
                    ...
                    <li className="font-[500] transition-all duration-150">
                        <Link className={`${
                            path === "/about" ? "text-gray-200 font-normal underline" : "text-white font-semibold"
                        }`}
                        to="/about" > About</Link>
                    </li>
                    ...
                    <li className="font-[500] transition-all duration-150">
                        <Link className={`${
                            path === "/contact" ? "text-gray-200 font-normal underline" : "text-white font-semibold"
                        }`}
                    ...
                    <li className="font-[500] transition-all duration-150">
                        <Link className={`${
                            path === "/cart" ? "text-gray-200 font-normal" : "text-white font-semibold"
                        }`}
